...
/// </summary>
public class AzureComputerVisionTextEmbeddingGenerator : IEmbeddingGenerator<string, Embedding<float>>
{
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly string _httpClientName;
    private readonly string _modelVersion;

    public AzureComputerVisionTextEmbeddingGenerator(
    ...
    public EmbeddingGeneratorMetadata Metadata => new("AzureComputerVisionTextEmbedding", null, _modelVersion);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var text in values)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, 
                $"computervision/retrieval:vectorizeText?api-version=2024-02-01&model-version={_modelVersion}");
